...
#define NOME_ALUNO "Armando Caliari"
#define RM_ALUNO "86765"
...
void app_main(void) {
    printf("{Armando Caliari-RM:86765} [SISTEMA] Iniciando CP2 - Sistema de Dados Robusto.\n");
 
    xFilaDeDados = xQueueCreate(TAMANHO_FILA, sizeof(int));
    if (xFilaDeDados == NULL) {
        printf("{Armando Caliari-RM:86765} [SISTEMA] Falha ao criar a fila.\n");
        return;
    }
    ...
    printf("{Armando Caliari-RM:86765} [SISTEMA] Inicializacao concluida. WDT ja ativo.\n");
